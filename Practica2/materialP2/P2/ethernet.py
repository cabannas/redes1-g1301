...
def startEthernetLevel(interface):
    ...
    # Una vez hemos abierto la interfaz para captura y hemos inicializado las variables globales (macAddress,
    # handle y levelInitialized) arrancamos el hilo de recepción
    recvThread = rxThread()
